...
1. **New tables lacked default-deny row protection.** The constrained compiler now enables and forces RLS and revokes public privileges before committing newly created tables. The real product's tenant keys, policies, grants, and bootstrap remain separately certified work; this narrow compiler is not a complete application schema installer.
